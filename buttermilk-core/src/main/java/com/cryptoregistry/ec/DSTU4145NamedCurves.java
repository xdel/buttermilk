...
class DSTU4145NamedCurves {
	...
	private static final DSTU4145NamedCurves instance = new DSTU4145NamedCurves();
	
	private static final BigInteger ZERO = BigInteger.valueOf(0);
	private static final BigInteger ONE = BigInteger.valueOf(1);
	private static final String NAME = "DSTU4145";
	    
	public ECDomainParameters params [] = new ECDomainParameters[10];
	
	private DSTU4145NamedCurves() {
		super();
		init();
	}
	
	public static DSTU4145NamedCurves getInstance() {
		return instance;
	}
	...
	private void init() {
	        ...
	        for (int i = 0; i < params.length; i++){
	            params[i] = new ECDomainParameters(curves[i], points[i], n_s[i],NAME+"."+i);
	        }
	}
